...
EXPERIENCE:
Full Stack Developer Intern — Decentralclasses (Jul 2025 – Nov 2025, Remote)
• Implemented Google OAuth 2.0 authentication for secure user login and seamless account access
• Assisted in content updates, project coordination, and timely delivery of feature enhancements for the platform
• Optimized frontend components for better responsiveness, performance, and faster load times
...
SKILLS:
• Frontend: Next.js 16, TypeScript, JavaScript (ES6+), ReactJS, React Router, Redux, Redux Toolkit, Tailwind CSS, Material UI
